/* Sticky table headers for markserv-marker pages.
   ...
   The shells live on <body>, outside #marker-content, so their text is
   nowhere near the corpus comments.js matches quotes against, and they take
   no pointer events: the header they copy is the one you can select. */
(function () {
	'use strict';
